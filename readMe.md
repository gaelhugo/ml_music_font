...
Everything happens in the browser, using [TENSORFLOW JS](https://www.tensorflow.org/js) behind the scenes for all the machine learning infrastucture.
...
<br/>(ml5 sketchrnn cat model example)
...
Example provided as examplein the context of a talk as introduction of a machine learning used with variable fonts<br/> Please notify the author if you're planning to use it.
